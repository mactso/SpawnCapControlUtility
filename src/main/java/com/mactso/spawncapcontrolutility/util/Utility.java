...
//		}
	...
	public static boolean isNotNearWebs(BlockPos pos, ServerLevel serverworld) {

		if (serverworld.getBlockState(pos).getBlock() == Blocks.COBWEB)
			return true;
		if (serverworld.getBlockState(pos.above()).getBlock() == Blocks.COBWEB)
			return true;
		if (serverworld.getBlockState(pos.below()).getBlock() == Blocks.COBWEB)
			return true;
